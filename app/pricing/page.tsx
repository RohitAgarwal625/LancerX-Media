...
export default function PricingPage() {
  ...
  const planFeatures = {
    starter: [
      "1 social platform (Instagram / TikTok)",
      "15 reels/month",
      "Clickbait-Optimized Thumbnails",
      "Basic Optimization",
      "Weekly Performance Reports",
      "Email Support",
    ],
    growth: [
      "2 social platforms (Youtube, Insta/TikTok)",
      "30 reels/month",
      "High-CTR Thumbnails",
      "Advanced SEO",
      "Guidance",
    ...
    viral: [
      "All major social platforms (LinkedIn, Insta Etc.)",
      "60 Premium reels/month",
      "High-CTR Thumbnails",
      "Advanced AI powered SEO",
      "Sales Funnel & Leads Generate",
  ...
  const packageFeatures = {
    basic: [
      ...
      "90 Professional reels",
      "Content Research & Strategy",
      "Signature editing style according to your branding",
      "Monthly Performance Analysis",
      "Email & Chat Support",
    ],
    professional: [
      "All major social platforms",
      "180 Professional reels",
      "Advanced Strategy",
      "24/7 Support",
      "Signature editing style according to your branding",
  ...
  const comparisonData = [
    { feature: "Content Creation", competitors: "Basic templates", us: "Custom tailored content" },
    { feature: "Optimization", competitors: "Generic SEO", us: "Platform-specific algorithms" },
    { feature: "Strategy", competitors: "One-size-fits-all", us: "Personalized growth plan" },
